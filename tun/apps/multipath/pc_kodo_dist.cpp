...
int main(int argc, char** argv)
{
    ...
    if (argc < 14 || (argc % 5) != 4)
    {
        std::cout << strrchr(argv[0], '/')+1 << " [tunif] [kodo redundancy factor] [decode stat file] [local ip 1] [remote ip 1] [local port 1] [remote port 1] [probability 1] [local ip 2] [remote ip 2] [local port 2] [remote port 2] [probability 2] ..." << std::endl;
        ...
        std::cout << std::endl
                  ...
                  << "[probability]               " PROBABILITY_HELP_STRING << std::endl
                  << std::endl;
